            ...
            K = {
              ...
              VIDEO: function (e, t) {
                B(e, function (e) {
                  ...
                  j(e, W),
                  U(e, h, T(e, t.data_poster)),
                  U(e, c, T(e, t.data_src)),
                  e.load();
              },
              OBJECT: function (e, t) {
                j(e, H), U(e, g, T(e, t.data_src));
              },
            },
  ...
  (() => {
    ...
    function w(e, t) {
      ...
      if (f(e) && t) {
        var o = e.offsetHeight,
          r = e.offsetWidth;
        r > 0 && (s = b(i.width) / r || 1), o > 0 && (n = b(i.height) / o || 1);
      }
      return {
        width: i.width / s,
        height: i.height / n,
    ...
    function D(e) {
      for (var t = p(e), i = k(e); i && P(i) && "static" === E(i).position; )
        i = k(i);
      return i &&
        ("html" === T(i) || ("body" === T(i) && "static" === E(i).position))
        ? t
        : i ||
            (function (e) {
              var t =
    ...
    var $ = "top",
      ...
      j = [].concat(W, [V]).reduce(function (e, t) {
    ...
    function oe(e) {
      ...
      var M,
        z = Object.assign({ position: a }, c && ne),
        A =
          !0 === d
            ? (function (e) {
                var t = e.x,
    ...
    function ye(e, t) {
      ...
      var i = t,
        ...
        p = i.padding,
        f = void 0 === p ? 0 : p,
        m = me("number" != typeof f ? f : ve(f, W)),
        v = d === R ? "reference" : R,
        y = e.rects.popper,
        b = e.elements[h ? v : d],
        x = fe(g(b) ? b : b.contextElement || S(e.elements.popper), r, l),
        ...
        if (C) {
          if (o) {
            var P,
              ...
              Q = be(0, E[W], U[W]),
              se = x
                ? E[W] / 2 - X - Q - K - M.mainAxis
                : j - Q - K - M.mainAxis,
              ne = x
                ? -E[W] / 2 + X + Q + J + M.mainAxis
                : Y + Q + J + M.mainAxis,
              ...
              re = oe
                ? "y" === T
                  ...
                  : oe.clientLeft || 0
                : 0,
              ae = null != (P = null == z ? void 0 : z[T]) ? P : 0,
              le = H + ne - ae,
              ce = be(p ? y(N, H + se - ae - re) : N, H, p ? v(R, le) : R);
            (C[T] = ce), (A[T] = ce - H);
          }
          if (a) {
            var de,
              ...
              me = pe - m[he],
              ve = -1 !== [$, B].indexOf(b),
              we = null != (de = null == z ? void 0 : z[S]) ? de : 0,
              xe = ve ? fe : pe - E[ge] - I[ge] - we + M.altAxis,
              Te = ve ? pe + E[ge] + I[ge] - we - M.altAxis : me,
              Se =
                p && ve
                  ? (function (e, t, i) {
                      var s = be(e, t, i);
      ...
      fn: function (e) {
        ...
        if (o && r) {
          var d = (function (e, t) {
            ...
            T = be(b, x, w),
            S = l;
          i.modifiersData[s] = (((t = {})[S] = T), (t.centerOffset = T - x), t);
        }
      },
      effect: function (e) {
        var t = e.state,
    ...
    function rt(e, t) {
      var i = Object.assign(
        ...
        t.ignoreAttributes
          ...
          : (function (e, t) {
              return (
                t ? Object.keys(ot(Object.assign({}, st, { plugins: t }))) : nt
              ).reduce(function (t, i) {
    ...
    function ft(e, t) {
      var i,
        ...
        b = {
          ...
          setProps: function (t) {
            ...
            var i = b.props,
              s = rt(e, Object.assign({}, i, Ve(t), { ignoreAttributes: !0 }));
            (b.props = s),
              R(),
              i.interactiveDebounce !== s.interactiveDebounce &&
                (_(), (m = De(Y, s.interactiveDebounce)));
          ...
          show: function () {
            ...
            var e = b.state.isVisible,
              ...
              n = Ae(b.props.duration, 0, st.duration);
            if (e || t || i || s) return;
            ...
            P(), W(), b.state.isMounted || (x.style.transition = "none");
            if (L()) {
              var o = z(),
                r = o.box,
                l = o.content;
            ...
            (a = function () {
              ...
              (function () {
                var e,
                  ...
                  i = O();
                e =
                  (b.props.interactive && t === ze) || "parent" === t
                    ? i.parentNode
                    : ke(t, [i]);
          ...
          hide: function () {
            ...
            var e = !b.state.isVisible,
              t = b.state.isDestroyed,
              i = !b.state.isEnabled,
              s = Ae(b.props.duration, 1, st.duration);
            if (e || t || i) return;
      ...
      function A(e) {
        return (b.state.isMounted && !b.state.isVisible) ||
          ...
          (o && "focus" === o.type)
          ? 0
          : Ae(b.props.delay, e ? 0 : 1, st.delay);
      }
      function P(e) {
        void 0 === e && (e = !1),
      ...
      function H(e, t) {
        var i = z().box;
        function s(e) {
          e.target === i && (qe(i, "remove", s), t());
        }
        if (0 === e) return t();
        qe(i, "remove", r), qe(i, "add", s), (r = s);
      }
      function N(t, i, s) {
        void 0 === s && (s = !1),
          $e(b.props.triggerTarget || e).forEach(function (e) {
      ...
      function ee(e) {
        b.clearDelayTimeouts(), e && k("onTrigger", [b, e]), W();
        var t = A(!0),
          s = E(),
          n = s[0],
          o = s[1];
    ...
    function Et(e = []) {
      ...
      return (
        e.forEach((e) => {
          Array.isArray(e) ? t.push(...Et(e)) : t.push(e);
        }),
        t
      );
    }
    ...
    const zt = {
      ...
      hasClass: function (...e) {
        const t = Et(e.map((e) => e.split(" ")));
        return (
          It(this, (e) => t.filter((t) => e.classList.contains(t)).length > 0)
            .length > 0
        );
      },
      ...
      on: function (...e) {
        ...
        function o(e) {
          ...
          if ((n.indexOf(e) < 0 && n.unshift(e), Lt(t).is(i))) s.apply(t, n);
          else {
            const e = Lt(t).parents();
            for (let t = 0; t < e.length; t += 1)
              Lt(e[t]).is(i) && s.apply(e[t], n);
          }
        }
        function r(e) {
      ...
      nextAll: function (e) {
        ...
        for (; i.nextElementSibling; ) {
          ...
          e ? Lt(s).is(e) && t.push(s) : t.push(s), (i = s);
        }
        return Lt(t);
      },
      prev: function (e) {
      ...
      parent: function (e) {
        ...
        for (let i = 0; i < this.length; i += 1)
          null !== this[i].parentNode &&
            (e
              ? Lt(this[i].parentNode).is(e) && t.push(this[i].parentNode)
      ...
      parents: function (e) {
        ...
        for (let i = 0; i < this.length; i += 1) {
          ...
          for (; s; )
            e ? Lt(s).is(e) && t.push(s) : t.push(s), (s = s.parentNode);
        }
        return Lt(t);
      },
      closest: function (e) {
    ...
    Object.keys(zt).forEach((e) => {
      Object.defineProperty(Lt.fn, e, { value: zt[e], writable: !0 });
    });
    const At = Lt;
    function Pt(e, t) {
          ...
          for (let t = 0, n = i.length; t < n; t += 1) {
            ...
            void 0 !== o &&
              ...
              ($t(e[n]) && $t(s[n])
                ...
                : !$t(e[n]) && $t(s[n])
                ? ((e[n] = {}),
                  s[n].__swiper__ ? (e[n] = s[n]) : Gt(e[n], s[n]))
                : (e[n] = s[n]));
          }
        }
      }
    ...
    const Yt = {
      ...
      updateSlides: function () {
        ...
        if (
          ...
          S && e.grid.updateWrapperSize(C, h, t),
          !s.centeredSlides)
        ) {
          const t = [];
        ...
        if (
          ...
          Bt(e.wrapperEl, "--swiper-centered-offset-before", -h[0] + "px"),
            Bt(
              e.wrapperEl,
        ...
        if (
          ...
          if (0 === t) a[e ? "scrollLeft" : "scrollTop"] = -d;
            ...
            if (!o.support.smoothScroll)
              return (
                Vt({ swiper: o, targetPosition: -d, side: e ? "left" : "top" }),
                !0
              );
      ...
      slideTo: function (e, t, i, s, n) {
        ...
        if (a.cssMode) {
          ...
          if (0 === t) {
            ...
            if (!o.support.smoothScroll)
              return (
                Vt({ swiper: o, targetPosition: i, side: e ? "left" : "top" }),
                !0
              );
    ...
    const ai = {
        attachEvents: function () {
          ...
          (e.onTouchStart = Jt.bind(e)),
            ...
            (e.onTouchEnd = ei.bind(e)),
            i.cssMode && (e.onScroll = si.bind(e)),
            (e.onClick = ii.bind(e)),
            s.touch && !ni && (t.addEventListener("touchstart", oi), (ni = !0)),
            ri(e, "on");
        },
      ...
      li = (e, t) => e.grid && t.grid && t.grid.rows > 1;
    const ci = {
      setBreakpoint: function () {
        ...
        h && i && e.changeDirection(), Gt(e.params, l);
        ...
        transition: {
          ...
          transitionStart: function (e, t) {
            ...
            s.cssMode ||
              ...
              Ut({ swiper: i, runCallbacks: e, direction: t, step: "Start" }));
          },
          transitionEnd: function (e, t) {
            ...
            (i.animating = !1),
              s.cssMode ||
                (i.setTransition(0),
                Ut({ swiper: i, runCallbacks: e, direction: t, step: "End" }));
          },
        },
        slide: Zt,
        loop: Kt,
    ...
    class fi {
      constructor() {
        ...
        (o.__swiper__ = !0),
          (o.support = Nt()),
          (o.device = Rt({ userAgent: t.userAgent })),
          (o.browser = Xt()),
          (o.eventsListeners = {}),
    ...
    Object.keys(pi).forEach((e) => {
      Object.keys(pi[e]).forEach((t) => {
        fi.prototype[t] = pi[e][t];
      });
    }),
      fi.use([
        function (e) {
      ...
      (i.autoplay = { running: !1, paused: !1 }),
        ...
        n("init", () => {
          if (i.params.autoplay.enabled) {
            a();
            xt().addEventListener("visibilitychange", d),
        ...
        n("destroy", () => {
          ...
          xt().removeEventListener("visibilitychange", d);
        }),
    ...
    window.addEventListener("load", function (e) {
      document.querySelector(".team") &&
        new mi(".team__slider", {
          ...
          slidesPerView: 3,
          spaceBetween: 30,
          autoplay: { delay: 2300, disableOnInteraction: !1 },
          speed: 300,
          loop: !0,
          grabCursor: !0,
          lazy: !0,
    ...
    var xi = "lgAfterAppendSlide",
      Ti = "lgInit",
      Si = "lgHasVideo",
      Ci = "lgContainerResize",
      Ei = "lgUpdateSlides",
      Ii = "lgAfterAppendSubHtml",
      Li = "lgBeforeOpen",
      Oi = "lgAfterOpen",
      Mi = "lgSlideItemLoad",
      zi = "lgBeforeSlide",
      ...
      Di = "lgDragMove",
      $i = "lgDragEnd",
      _i = "lgBeforeNextSlide",
      Gi = "lgBeforePrevSlide",
      Bi = "lgBeforeClose",
      Vi = "lgAfterClose",
      Wi = {
        mode: "lg-slide",
    ...
    var Fi = (function () {
      ...
      return (
        ...
        (e.prototype.find = function (e) {
          return Hi(this._getSelector(e, this.selector));
        }),
        ...
        (e.prototype.eq = function (e) {
          return Hi(this.selector[e]);
        }),
        (e.prototype.parent = function () {
          return Hi(this.selector.parentElement);
        }),
    ...
    var Xi = function (e, t, i, s) {
        void 0 === i && (i = 0);
        var n = Hi(e).attr("data-lg-size") || s;
        if (n) {
          var o = n.split(",");
          if (o[1])
        ...
        return (
          (e.prototype.generateSettings = function (e) {
            if (
              ...
              var t = wi(
                wi({}, this.settings.mobileSettings),
                this.settings.mobileSettings
              );
              this.settings = wi(wi({}, this.settings), t);
            }
          }),
          ...
          (e.prototype.getSlideItem = function (e) {
            return Hi(this.getSlideItemId(e));
          }),
            ...
            if (!(this.$container && this.$container.get())) {
              ...
              var n = this.settings.ariaLabelledby
                ...
                c =
                  ...
                  "\n                </div>\n            </div>\n        </div>\n        ";
              Hi(this.settings.container).append(c),
                document.body !== this.settings.container &&
                  Hi(this.settings.container).css("position", "relative"),
            ...
            if ("this" === this.settings.selector) this.items.push(this.el);
              ...
              if ("string" == typeof this.settings.selector)
                if (this.settings.selectWithin) {
                  var e = Hi(this.settings.selectWithin);
          ...
          (e.prototype.openGallery = function (e, t) {
            ...
            if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
              ...
              this.zoomFromOrigin &&
                ...
                (o = ji(t, this.outer, a, l, this.currentImageSize))),
              ...
              setTimeout(function () {
                ...
                (this.index = e),
                this.LGel.trigger(Li),
                this.getSlideItem(e).addClass("lg-current"),
                (this.lGalleryOn = !1),
                (this.prevScrollTop = Hi(window).scrollTop()),
                setTimeout(function () {
          ...
          (e.prototype.addHtml = function (e) {
              ...
              if (t) {
                ...
                ("." !== s && "#" !== s) ||
                  (t =
                    ...
                    !this.settings.dynamic
                      ? Hi(this.items).eq(e).find(t).first().html()
                      : Hi(t).first().html());
              } else t = "";
            if (".lg-item" !== this.settings.appendSubHtmlTo)
              ...
              var n = Hi(this.getSlideItemId(e));
              i
                ? n.load(i)
          ...
          (e.prototype.getDummyImageContent = function (e, t, i) {
            var s;
            if ((this.settings.dynamic || (s = Hi(this.items).eq(t)), s)) {
              var n = void 0;
              if (
          ...
          (e.prototype.addSlideVideoInfo = function (e) {
            ...
            e.forEach(function (e, i) {
              (e.__slideVideoInfo = es(e.src, !!e.video, i)),
                e.__slideVideoInfo &&
          ...
          (e.prototype.loadContent = function (e, t) {
            ...
            if (
              ...
              if (f) {
                ...
                T = Ki(o, S || "", g, this.settings.strings.playVideo, p);
                n.prepend(T);
              } else if (p) {
              ...
              (o || p) &&
                ...
                this.LGel.trigger(xi, { index: e }),
                this.lGalleryOn &&
                  ".lg-item" === this.settings.appendSubHtmlTo &&
                  this.addHtml(e);
            }
            var E = 0;
            v && !Hi(document.body).hasClass("lg-from-hash") && (E = v),
              this.isFirstSlideWithZoomAnimation() &&
                (setTimeout(function () {
                  n.removeClass(
            ...
            "lg-slide" !== this.settings.mode &&
              ...
              setTimeout(function () {
                ...
                if (
                  ...
                  var a = Hi(i.target);
                  n.isPosterElement(a) && n.LGel.trigger(Pi);
                }
              ...
              this.$inner.on("touchend.lg", function (o) {
                if ("swipe" === e.touchAction) {
                  if (s) (s = !1), e.touchEnd(i, t, o);
                    ...
                    var r = Hi(o.target);
                    e.isPosterElement(r) && e.LGel.trigger(Pi);
                  }
          ...
          (e.prototype.enableDrag = function () {
            ...
            this.settings.enableDrag &&
              ...
              Hi(window).on("mousemove.lg.global" + this.lgId, function (o) {
                s &&
                  e.lgOpened &&
                  ((n = !0),
              ...
              Hi(window).on("mouseup.lg.global" + this.lgId, function (o) {
                if (e.lgOpened) {
                  var r = Hi(o.target);
                  n
                    ? ((n = !1), e.touchEnd(i, t, o), e.LGel.trigger($i))
                    : e.isPosterElement(r) && e.LGel.trigger(Pi),
                    s &&
                      ((s = !1),
            ...
            e && this.galleryItems.length < 3 && (i = !1),
              this.lgBusy ||
                (this.index + 1 < this.galleryItems.length
                  ? (this.index++,
                    this.LGel.trigger(_i, { index: this.index }),
          ...
          (e.prototype.goToPrevSlide = function (e) {
            ...
            e && this.galleryItems.length < 3 && (i = !1),
              this.lgBusy ||
                (this.index > 0
                  ? (this.index--,
                    this.LGel.trigger(Gi, { index: this.index, fromTouch: e }),
          ...
          (e.prototype.keyPress = function () {
            var e = this;
            Hi(window).on("keydown.lg.global" + this.lgId, function (t) {
              e.lgOpened &&
                !0 === e.settings.escKey &&
                27 === t.keyCode &&
                (t.preventDefault(),
          ...
          (e.prototype.closeGallery = function (e) {
            ...
            this.LGel.trigger(Bi), Hi(window).scrollTop(this.prevScrollTop);
            var i,
            ...
            return (
              ...
              setTimeout(function () {
                t.zoomFromOrigin &&
                  ...
                  t.$inner.empty(),
                  t.lgOpened && t.LGel.trigger(Vi, { instance: t }),
            ...
            return (
              setTimeout(function () {
                e.destroyModules(!0),
                  ...
                  Hi(window).off(".lg.global" + e.lgId),
                  e.LGel.off(".lg"),
                  e.$container.remove();
              }, t),
              t
    ...
    var ns = i(86),
      ...
      rs = i(114),
      as = i(97);
    const ls = document.querySelectorAll("[data-gallery]");
    if (ls.length) {
      let t = [];
      ls.forEach((e) => {
        t.push({
