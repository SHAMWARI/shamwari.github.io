(() => {
  ...
  function re(e) {
    ...
    function l() {
      ...
      if (
        ...
        e.children(`.${s.slideVisibleClass}`).each((e) => {
          o(r ? w(e).attr("data-swiper-slide-index") : w(e).index());
        });
    ...
    function d() {
      ...
      const s = t.params.lazy.scrollingElement
          ? w(t.params.lazy.scrollingElement)
          : w(e),
        i = s[0] === e,
      ...
      u ? (l(), s.off("scroll", d, f)) : r || ((r = !0), s.on("scroll", d, f));
    }
    i("beforeInit", () => {
  ...
  function ae(e, t, s) {
    ...
    return (
      r.length ||
        ((r = w(`<div class="swiper-slide-shadow${s ? `-${s}` : ""}"></div>`)),
        n.append(r)),
      r
    );
  }
      ...
      setTranslate: () => {
        ...
        for (let e = 0, t = i.length; e < t; e += 1) {
          ...
          if (
            ...
            0 === e.length && (e = ae(r, t, a ? "left" : "top")),
              0 === s.length && (s = ae(r, t, a ? "right" : "bottom")),
