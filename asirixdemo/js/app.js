(() => {
  ...
  const g = {
    ...
    on: function (...e) {
      ...
      function n(e) {
        ...
        if ((r.indexOf(e) < 0 && r.unshift(e), h(t).is(s))) i.apply(t, r);
        else {
          const e = h(t).parents();
          for (let t = 0; t < e.length; t += 1)
            h(e[t]).is(s) && i.apply(e[t], r);
        }
      }
      function a(e) {
    ...
    offset: function () {
      if (this.length > 0) {
        ...
        return { top: i.top + l - n, left: i.left + c - a };
      }
      return null;
    },
    css: function (e, t) {
    ...
    is: function (e) {
      ...
      if ("string" == typeof e) {
        ...
        for (r = h(e), n = 0; n < r.length; n += 1) if (r[n] === i) return !0;
        return !1;
      }
      if (e === s) return i === s;
      if (e === t) return i === t;
  ...
  const _ = {
    ...
    slideToClickedSlide: function () {
      ...
      if (t.loop) {
        ...
        (r = parseInt(v(e.clickedSlide).attr("data-swiper-slide-index"), 10)),
          t.centeredSlides
  ...
  const D = {
    loopCreate: function () {
      const e = this,
        ...
        r = i.children().length > 0 ? v(i.children()[0].parentNode) : i;
      ...
      for (let e = 0; e < l.length; e += 1)
        r.append(v(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = a.length - 1; e >= 0; e -= 1)
        r.prepend(v(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
  ...
  function G(e) {
    const t = this,
      ...
      i = d(),
      r = t.touchEventsData,
      { params: n, touches: a, enabled: l } = t;
    if (!l) return;
    ...
    if (
      ...
      p.is(r.focusableElements) && (e = !1),
        s.activeElement &&
          v(s.activeElement).is(r.focusableElements) &&
          s.activeElement !== p[0] &&
  ...
  function se({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function y(t) {
      ...
      o.touch
        ? (l[p](i.start, b, d), l[p](i.move, T, d), l[p](i.end, S, c))
        : (l[p](n.start, b, d), r[p](n.move, T, d), r[p](n.end, S, c));
    }
    function E() {
      ...
      0 === n.length &&
        ((n = v(`<div class="${e.params.scrollbar.dragClass}"></div>`)),
        r.append(n)),
  ...
  function ie({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    (e.autoplay = { running: !1, paused: !1 }),
      ...
      Object.assign(e.autoplay, { pause: d, run: n, start: a, stop: l });
  }
  function re() {
    ...
    re(),
      document.querySelector(".team") &&
        new te(".team__slider", {
          ...
          scrollbar: { el: ".team__scrollbar", draggable: !0, dragSize: 80 },
          slidesPerView: 4,
          spaceBetween: 30,
          speed: 800,
          breakpoints: {
